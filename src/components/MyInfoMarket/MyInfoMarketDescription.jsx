    ...
    return (
        <DesciptionSection>
            <DesciptionContainer>
                ...
                <ImageContainer >
                    <img style={{width: "20vw"}} src="https://bosees.github.io/datalabs_homepage_react/images/my_info_phone.png" alt="폰 사진"/>
                    <div style={{width:"25vw", marginLeft:"5rem"}}>
                        ...
                        <div style={{marginTop:"2rem", display: "flex", width: "20vw"}}>
                            <img style={{marginRight: "1rem", width: "10vw", height: "3vw"}} src="https://bosees.github.io/datalabs_homepage_react/images/google_button.png" alt="버튼1" />
                            <img style={{marginRight: "1rem", width: "10vw", height: "3vw"}} src="https://bosees.github.io/datalabs_homepage_react/images/apple_button.png" alt="버튼2" />
                        </div>
                    </div>
                </ImageContainer>
            </DesciptionContainer>
