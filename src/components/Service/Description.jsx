        ...
        <DescriptionContainer>
            <Description1>
                ...
                <div style={{position:"relative", flex:1.7, display:"flex"}}>
                    <img style={{ width: "100%", height: "100%", objectFit: "cover",float:"right"}}  src="https://bosees.github.io/datalabs_homepage_react/images/service_description1.png" alt="서비스 설명 1"/>
            ...
            <Description2>
                <div style={{position:"relative", flex:1.7, display:"flex"}}>
                    <img style={{ width: "100%", height: "100%", objectFit: "cover",float:"right"}}  src="https://bosees.github.io/datalabs_homepage_react/images/service_description2.png" alt="서비스 설명 2"/>
